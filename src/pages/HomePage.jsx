  ...
  function NoListing() {
    return (
      <div className="max-w-6xl ">
        <p className="text-gray-600 text-center my-6 text-sm lg:text-xl font-bold">
          Sorry, There are no Listings to be shown right now!
        </p>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto  p-4 space-y-6">
        {offerListings && offerListings.length > 0 && (
          <div className="m-2 mb-6">
            <h2 className="px-3 lg:text-3xl text-sm mt-6 font-semibold">
              Recent Offers
            </h2>
            ...
            <ul className="sm:grid sm:grid-cols-2 sm:gap-x-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        {saleListings && saleListings.length > 0 && (
          <div className="m-2 mb-6">
            <h2 className="px-3 text-sm lg:text-3xl mt-6 font-semibold">
              {" "}
              Places for <span className="text-secondary">Sale</span>
            </h2>
            ...
            <ul className="sm:grid sm:grid-cols-2 my-6 lg:grid-cols-3 xl:grid-cols-4">
              {saleListings?.map((item) => (
                <ListingItem key={item?.id} {...item} id={item?.id} />
              ))}
            </ul>
          </div>
        )}
        ...
        {rentListings && rentListings.length > 0 && (
          <div className="m-2 mb-6">
            <h2 className="px-3 text-sm lg:text-3xl mt-6 font-semibold">
              Places for <span className="text-secondary">Rent</span>
            </h2>
            ...
            <ul className="sm:grid sm:grid-cols-2 my-6 sm:gap-x-3 lg:grid-cols-3 xl:grid-cols-4">

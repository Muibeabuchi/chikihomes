...
function OffersPage() {
  ...
  const offersQuery  = query(colRef,where('offer','==',true),orderBy('timestamp','desc'),limit(16));
  ...
  return (
    <div className="max-w-6xl mx-auto px-3">
      <h1 className="text-3xl text-center font-bold mt-6 mb-6">Offers</h1>
      {
        ...
        ): <p className="text-xl font-semibold capitalize">There are no Listings to display</p>
      }
    </div>
  )
}

    ...
    <section className=''>
      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto gap-x-6">
        ...
        <div className='w-full md:w-[67%] lg:w-[40%]'>
          ...
          <button type='button' className='w-full bg-blue-600 rounded-sm shadow-md hover:bg-blue-700 transition ease-in-out hover:shadow-lg active:bg-blue-800 text-white px-7 py-3 font-medium text-sm uppercase mt-4'>Register</button>
